...
<body>  
	...
	<script src="index.js"></script>
     ...
     <?php include 'post.php'; ?>    <!--Adds the post form so that people can leave comments-->
        ...
        ?>
         ...
         <div class="display_dateTime">Posted on: <?php echo $post_date; ?> <b>|</b> <?php echo $post_time; ?></div><hr>  
    ...
    <div class="display_dateTimeReply"><?php echo $reply_date . " | " . $reply_time ?></div>
